...
/*
| ─────────────────────────────────────────────────────────────
| layouts/header_admin.php
| ─────────────────────────────────────────────────────────────
| Partial header & sidebar untuk halaman Admin.
| Di-include di awal setiap view admin.
| Variabel yang digunakan:
|   $title  → judul halaman (title tag)
|   $active → string nama menu aktif (untuk highlight sidebar)
*/
...
<head>
    ...
    <title><?= $title ?? 'Admin — LaundryKu' ?></title>
<style>
/* ============================================================
   LaundryKu — Embedded CSS (Admin Layout)
...
.nav-label {
    ...
    color: var(--gray-400); padding: 10px 20px 6px;
}
.sidebar-nav a {
...
<div class="app-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-label" style="margin-top:10px;">Publik</div>
            <a href="<?= base_url('cek-status') ?>" target="_blank" id="nav-cekstatus">
